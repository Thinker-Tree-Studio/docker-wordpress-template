...
if ( ! function_exists( 'thinkertree_setup' ) ) :
	...
	function thinkertree_setup() {
		 ...
		 */
		load_theme_textdomain( 'thinkertree', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'thinkertree_custom_background_args', array(
